                    ...
                    <div className="space-y-8 text-slate-300 leading-relaxed">
                        ...
                        <section>
                            ...
                            <ul className="list-disc pl-6 mt-2 space-y-2">
                                <li>Visit <a href="https://myadcenter.google.com/" className="text-indigo-400 hover:text-indigo-300 underline" target="_blank" rel="noopener noreferrer">Google's Ads Settings</a>.</li>
                                <li>Visit <a href="http://www.aboutads.info/choices/" className="text-indigo-400 hover:text-indigo-300 underline" target="_blank" rel="noopener noreferrer">AboutAds.info</a> to opt out of a broader range of third-party vendor's use of cookies for personalized advertising.</li>
                            </ul>
